...
const dev = false; // = mode === 'development';
  ...
  client: {
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...
        "process.env.REDIRECT_SERVICE_IP": JSON.stringify(
          process.env.REDIRECT_SERVICE_IP
        ),
        "process.env.PAYMENT_API_URL": JSON.stringify(
  ...
  server: {
    ...
    plugins: [
      new webpack.DefinePlugin({
        ...
        "process.env.PAYMENT_API_URL": JSON.stringify("https://nostrnames.org"), //process.env.PAYMENT_API_URL),
        "process.env.STRIPE_PUBLIC_KEY": JSON.stringify(
          process.env.STRIPE_PUBLIC_KEY
        ),
        "process.env.NODE_ENV": JSON.stringify(mode),
